...
var Check = new Schema({
  ...
  maxTime     : { type: Number, default: 5000 },  // time under which a ping is considered responsive
  alertTreshold : { type: Number, default: 4 },   // nb of errors from which to trigger a new CheckEvent
